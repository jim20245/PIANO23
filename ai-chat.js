...
class AIChat {
    ...
    getLocalResponse(message) {
        ...
        if (lowerMessage.includes('菜单') || lowerMessage.includes('菜品') || lowerMessage.includes('有什么')) {
            return '我们有多种招牌川菜，包括养生鸡汤、麻婆豆腐、红烧肉、辣子鸡等。您可以在"招牌菜品推荐"栏目查看详情。感谢您的咨询！我们是专业的美食餐厅，提供正宗美味的招牌菜。如果您有具体的问题，请随时告诉我，我会尽力为您解答。我们的人工客服19130133027，微信19130133027';
    } ';
        }

        if (lowerMessage.includes('价格') || lowerMessage.includes('钱')) {
            return '我们的菜品价格从45元到88元不等，具体价格可以查看各个菜品的详情。感谢您的咨询！我们是专业的美食餐厅，提供正宗美味的招牌菜。如果您有具体的问题，请随时告诉我，我会尽力为您解答。我们的人工客服19130133027，微信19130133027';
    } ';
        }
        ...
        if (lowerMessage.includes('营业') || lowerMessage.includes('时间')) {
            return '我们的营业时间是每天8:00-22:00，欢迎随时光临！感谢您的咨询！我们是专业的美食餐厅，提供正宗美味的招牌菜。如果您有具体的问题，请随时告诉我，我会尽力为您解答。我们的人工客服19130133027，微信19130133027';
    } ';
        }

        // 地址相关
        if (lowerMessage.includes('地址') || lowerMessage.includes('位置')) {
            return '我们的餐厅位于市中心繁华地段，您可以点击网站底部的联系方式查看详细地址。感谢您的咨询！我们是专业的美食餐厅，提供正宗美味的招牌菜。如果您有具体的问题，请随时告诉我，我会尽力为您解答。我们的人工客服19130133027，微信19130133027';
    } ';
        }

        // 常见问题
        if (lowerMessage.includes('配送') || lowerMessage.includes('外卖')) {
            return '是的，我们提供快速配送服务，让您足不出户就能品尝到正宗川菜美食。感谢您的咨询！我们是专业的美食餐厅，提供正宗美味的招牌菜。如果您有具体的问题，请随时告诉我，我会尽力为您解答。我们的人工客服19130133027，微信19130133027';
    } ';
        }

        if (lowerMessage.includes('食材') || lowerMessage.includes('新鲜')) {
            return '我们承诺所有菜品均使用新鲜食材，每日新鲜采购，严格筛选，确保每一道菜品的品质和口感。感谢您的咨询！我们是专业的美食餐厅，提供正宗美味的招牌菜。如果您有具体的问题，请随时告诉我，我会尽力为您解答。我们的人工客服19130133027，微信19130133027';
    } ';
        }

        if (lowerMessage.includes('辣') || lowerMessage.includes('口味')) {
            return '我们的川菜有多种辣度可以选择，从微辣到特辣，满足不同顾客的口味需求。您可以在下单时备注您的辣度偏好。感谢您的咨询！我们是专业的美食餐厅，提供正宗美味的招牌菜。如果您有具体的问题，请随时告诉我，我会尽力为您解答。我们的人工客服19130133027，微信19130133027';
        }';
        }

        // 默认回复
        return '感谢您的咨询！我们是专业的美食餐厅，提供正宗美味的招牌菜。如果您有具体的问题，请随时告诉我，我会尽力为您解答。我们的人工客服19130133027，微信19130133027';
    }
